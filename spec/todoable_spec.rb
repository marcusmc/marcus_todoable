...
describe Todoable do
    ...
    it "raises an error on incorrect authentication" do
    ...
    it "retrieves an authentication token" do
    ...
    it "retrieves a new token when it has expired" do
        subject.get_lists
